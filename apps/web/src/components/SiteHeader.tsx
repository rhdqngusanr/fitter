...
/*
 * 주요 내비. 시안(G-01)의 세 항목을 모두 켰다.
 *
 * `시공자 찾기`(C-06)는 그 화면이 생기면 켜기로 했고, 2026-07-26 에 켰다.
 *
 * `이용 방법` 은 **별도 화면이 아니라 랜딩의 `#how` 섹션이다** — 열린 질문 Q8 의
 * 답이 "화면을 만들지 않는다"였다. 랜딩의 3단계 섹션이 이미 같은 일을 하고 있어서
 * 거기에 역할 토글과 FAQ 를 붙이고 앵커를 걸었다. 화면 목록은 21개 그대로다.
 */
const NAV = [
